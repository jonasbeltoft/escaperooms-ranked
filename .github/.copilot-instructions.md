...
ALWAYS try to use ``bun`` to run, build, and test the project, including all dependencies and components to be installed. 
**CRITICAL** AT NO POINT SHOULD YOU USE NPM OR YARN OR NPX OR PNPM. ONLY BUN!

...
- [-] Find different color for stars.
  - not going to
- [x] Reviews only 1 per rov. Make more white space, as it's too dense right now.
- [x] The "Theme" rating needs a new name. It sounds like how much you like the theme, but it's supposed to mean theme ADHERENCE.
